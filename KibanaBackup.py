...
SavedObjectTypes = ['config','url','index-pattern','query','visualization','canvas-element','canvas-workpad','canvas-workpad-template','map','search','dashboard','lens','infrastructure-ui-source','metrics-explorer-view','inventory-view']
